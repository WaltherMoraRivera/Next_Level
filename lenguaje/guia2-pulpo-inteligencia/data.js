    ...
    },
    {
      ...
      vocab:[
        { word:'invertebrado', ctx:'"A pesar de ser un invertebrado —es decir, un animal sin columna vertebral—."',
          opts:['Animal sin columna vertebral','Animal con esqueleto interno de huesos','Animal que vive exclusivamente en el mar','Animal de sangre fría'], c:0,
        ...
        { word:'sigilo', ctx:'"El pulpo depende casi exclusivamente de su sigilo para sobrevivir."',
          opts:['Velocidad extrema al nadar','Fuerza física para enfrentar a otros animales','Discreción y cautela para pasar desapercibido','Curiosidad por explorar su entorno'], c:2,
        ...
        { word:'comprimirse', ctx:'"Su cuerpo blando le permite comprimirse y deslizarse por grietas diminutas."',
          opts:['Expandirse y ocupar más espacio del habitual','Cambiar de color rápidamente','Moverse a una velocidad muy alta','Reducirse de tamaño apretándose o encogiéndose'], c:3,
        ...
        { word:'letargo', ctx:'"Muchas hembras entran en un estado de letargo, dejan de alimentarse."',
          opts:['Estado de inactividad y bajo funcionamiento del cuerpo','Un tipo de enfermedad contagiosa','Una fase de crecimiento acelerado','Un comportamiento agresivo hacia otros animales'], c:0,
    ...
    },
    {
      ...
      questions:[
        { q:'¿Por qué el pulpo depende casi exclusivamente del sigilo y no de defensas físicas como espinas o caparazón?',
          opts:['Porque es un animal territorial que prefiere evitar el conflicto','Porque los científicos lo han entrenado en cautiverio para camuflarse','Porque vive en aguas donde no existen depredadores naturales','Porque su cuerpo blando y sin protecciones externas lo obliga a evitar el enfrentamiento directo'], c:3,
          ...
          fb_no:'❌ Piensa en la relación causa-efecto: "Sin caparazón ni espinas para defenderse, el pulpo depende casi exclusivamente de su sigilo para sobrevivir." La respuesta correcta era la D.' },
        { q:'¿Qué se puede inferir sobre la inteligencia del pulpo a partir del hecho de que recuerde soluciones a problemas después de varios días?',
          opts:['Que posee una forma de memoria y aprendizaje, no solo reacciones automáticas','Que actúa completamente por instinto, sin ningún tipo de memoria','Que los pulpos en cautiverio se vuelven más lentos con el tiempo','Que solo puede resolver el mismo problema una única vez'], c:0,
          ...
          fb_no:'❌ Si el pulpo "recuerda soluciones a problemas después de varios días", eso no puede ser solo instinto: implica memoria y aprendizaje real. La respuesta correcta era la A.' },
        { q:'¿Por qué crees que las hembras de pulpo dejan de alimentarse y entran en letargo después de que sus huevos eclosionan?',
          opts:['Porque enferman a causa del esfuerzo de poner los huevos','Porque pierden el instinto de búsqueda de alimento por error genético','Porque dedican sus últimas energías a proteger a sus crías antes de morir','Porque los depredadores las atacan justo en ese momento'], c:2,
          ...
          fb_no:'❌ El texto da la pista en su última frase: la hembra dedica "sus últimas fuerzas a protegerlos". Sugiere protección antes de morir, no una enfermedad. La respuesta correcta era la C.' }
      ]
    },
    {
      type:'open',
