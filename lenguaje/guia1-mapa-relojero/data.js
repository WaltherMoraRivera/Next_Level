    ...
    },
    {
      ...
      vocab:[
        { word:'angosto', ctx:'"Era un local angosto y oscuro, ubicado en el primer piso de un edificio antiguo."',
          opts:['Estrecho, de poco espacio','Amplio y bien iluminado','Antiguo y mal cuidado','Silencioso y sin clientes'], c:0,
        ...
        { word:'trastienda', ctx:'"Se asomó hacia la trastienda y vio que un reloj de pie antiguo se había inclinado."',
          opts:['La vitrina principal de una tienda','El espacio que está detrás del área de atención al público','La sala de espera de un local','La bodega del piso superior'], c:1,
        ...
        { word:'moldura', ctx:'"Sin querer presionó una moldura lateral que cedió hacia adentro."',
          opts:['Una manilla o picaporte de metal','Un tornillo oculto en la madera','Una franja decorativa que sobresale de una superficie','Una bisagra disimulada en la pared'], c:2,
        ...
        { word:'terciopelo', ctx:'"Dentro, envuelto en un paño de terciopelo rojo, había un tubo de cuero marrón."',
          opts:['Un tipo de madera fina y costosa','Un papel grueso resistente al agua','Un metal brillante parecido al cobre','Una tela suave con pelillo corto y denso'], c:3,
        ...
        { word:'quebradizo', ctx:'"Dentro encontró un papel amarillento y quebradizo, enrollado con cuidado."',
          opts:['Que se rompe o hace pedazos con facilidad','Muy valioso y difícil de conseguir','Con muchos colores y dibujos','Que huele a humedad y encierro'], c:0,
    ...
    },
    {
      ...
      questions:[
        { q:'¿Por qué crees que el compartimento secreto estaba escondido dentro del reloj de pie?',
          opts:['Era un defecto de fabricación que el reloj tenía desde la fábrica','Don Aurelio lo había construido para guardar el dinero del local','Valentina lo confundió con un compartimento normal de herramientas','Alguien lo diseñó con cuidado para ocultar el mapa de personas que no supieran buscarlo'], c:3,
          ...
          fb_no:'❌ Piensa en los detalles: el compartimento tenía una palanca disimulada en una moldura, el mapa estaba envuelto en terciopelo y mostraba pasillos secretos bajo el barrio. Todos estos detalles apuntan a que fue ocultado intencionalmente. La correcta era la D.' },
        { q:'¿Qué nos dice sobre el carácter de Valentina el hecho de que corriera a sostener el reloj "sin pensarlo"?',
          opts:['Que es una persona que reacciona rápido ante situaciones de riesgo','Que es una persona impulsiva a quien le gusta romper cosas','Que tenía miedo de que don Aurelio la culpara si se caía','Que quería aprovechar la oportunidad de explorar la trastienda'], c:0,
          ...
          fb_no:'❌ La pista está en "sin pensarlo". Cuando alguien actúa de ese modo ante un peligro, el autor nos muestra su instinto protector y su capacidad de reacción. La respuesta correcta era la A.' },
        { q:'¿Qué nos indica la frase "sintiendo el corazón latirle en la garganta" al final del texto?',
          opts:['Que Valentina estaba enferma y le costaba respirar','Que Valentina estaba exhausta de haber corrido por la tienda','Que Valentina sentía nerviosismo y tensión por lo que acababa de hacer','Que Valentina sentía alegría y emoción por la aventura'], c:2,
          ...
          fb_no:'❌ "El corazón latirle en la garganta" no es literal: es una metáfora corporal que describe el nerviosismo intenso. La respuesta correcta era la C.' }
      ]
    },
    {
      type:'open',
