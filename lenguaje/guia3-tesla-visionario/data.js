    ...
    },
    {
      ...
      vocab:[
        { word:'prodigio', ctx:'"Desde niño mostró ser un prodigio: podía realizar cálculos matemáticos complejos de memoria."',
          opts:['Una persona con problemas de aprendizaje','Una persona con capacidades excepcionales, fuera de lo común','Una persona tímida que evita a los demás','Una persona que memoriza sin comprender'], c:1,
        ...
        { word:'patente', ctx:'"Tesla registró decenas de patentes por sus inventos."',
          opts:['Un premio otorgado por un gobierno extranjero','Un documento oficial que protege legalmente la autoría de una invención','Un tipo de contrato de trabajo temporal','Un diploma universitario en ingeniería'], c:1,
        ...
        { word:'visionario', ctx:'"Tesla era un hombre tan visionario como excéntrico."',
          opts:['Una persona que solo se preocupa por el presente','Una persona capaz de imaginar o anticipar ideas y avances antes que los demás','Una persona que copia las ideas de otros','Una persona que rechaza cualquier tipo de cambio'], c:1,
        ...
        { word:'excéntrico', ctx:'"Tesla era un hombre tan visionario como excéntrico."',
          opts:['Extremadamente ordenado y predecible en sus rutinas','De comportamiento inusual o extravagante, distinto a lo convencional','Tímido y poco sociable con otras personas','Enfocado únicamente en ganar dinero'], c:1,
    ...
    },
    {
      ...
      questions:[
        { q:'¿Con cuánto dinero llegó Nikola Tesla a Estados Unidos en 1884?',
          opts:['Con una fortuna heredada de su familia','Con apenas cuatro centavos en el bolsillo','Con el salario adelantado por Thomas Edison','Con el dinero de la venta de sus primeras patentes'], c:1,
          ...
          fb_no:'❌ No es esa. El texto dice: "emigró a Estados Unidos con apenas cuatro centavos en el bolsillo". La respuesta correcta era la opción B.' },
        { q:'¿Quién fue el socio que apostó por el sistema de corriente alterna de Tesla?',
          opts:['Thomas Edison','George Westinghouse','J.P. Morgan','Alexander Graham Bell'], c:1,
          ...
          fb_no:'❌ Revisa el tercer párrafo: "Tesla... encontró en George Westinghouse a un socio dispuesto a apostar por la corriente alterna." La correcta era la opción B.' },
        { q:'Según el texto, ¿cómo pasó Tesla sus últimos días de vida?',
          opts:['Dando conferencias sobre sus inventos en universidades','Viviendo en un hotel de Nueva York, alimentando palomas y en la pobreza','Trabajando nuevamente junto a Thomas Edison','Retirado en su país natal junto a su familia'], c:1,
          ...
          fb_no:'❌ El texto lo indica claramente: "Tesla pasó sus últimos días en un hotel de Nueva York, alimentando palomas". La respuesta correcta era la B.' }
      ]
    },
    {
      type:'quiz',
      ...
      questions:[
        ...
        { q:'¿Qué se puede inferir sobre la personalidad de Tesla a partir de que invirtiera gran parte de su fortuna en la Torre Wardenclyffe, un proyecto que finalmente fracasó?',
          opts:['Que era una persona cautelosa que evitaba cualquier riesgo económico','Que era capaz de arriesgarlo todo por una idea en la que creía profundamente','Que no entendía nada sobre cómo administrar el dinero','Que prefería el reconocimiento inmediato antes que la innovación'], c:1,
          ...
          fb_no:'❌ El texto dice que invirtió "gran parte de su fortuna" en un proyecto de altísimo riesgo. Eso no es cautela, sino disposición a apostar todo por una idea. La respuesta correcta era la B.' },
        { q:'El texto describe la historia de Tesla como "irónica". ¿Por qué crees que se usa esa palabra?',
          opts:['Porque Tesla nunca inventó nada importante','Porque el hombre que ayudó a iluminar el mundo con electricidad murió pobre y casi olvidado','Porque Edison terminó siendo más pobre que Tesla','Porque la historia de Tesla es cómica y fue contada como un chiste'], c:1,
          ...
          fb_no:'❌ La ironía está en el contraste: Tesla ayudó a llevar electricidad al mundo entero, pero él mismo murió en el olvido y la pobreza. La respuesta correcta era la B.' }
      ]
    },
    {
      type:'open',
