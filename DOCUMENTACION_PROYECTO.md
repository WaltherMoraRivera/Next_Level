...
| 4 ✅ | Componiendo transformaciones: simetría de polígonos | OA14 | `dnd-sequence` (secuencia de pasos para componer rotación + reflexión) — **construida** (`matematicas/guia4-componiendo-transformaciones/`). Cierra la Unidad 3 completa (4 de 4). Verificada end-to-end: 100% (22/22 pts). |
